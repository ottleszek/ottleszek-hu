...
{
    public class BaseDataRepo<TEntity, TEntityDto, TAssembler> : IBaseDataService<TEntity, TEntityDto, TAssembler>
           ...
           where TAssembler : class, IAssembler<TEntity, TEntityDto>
    {
        ...
        public BaseDataRepo(IBaseMapperService<TEntity, TEntityDto, TAssembler>? mapperService)
        {
