...
{
    public class OrganizationProgramHttpRepo : IOrganizationProgramRepo
    {
        protected readonly HttpClient _httpClient;
        public OrganizationProgramHttpRepo(IHttpClientFactory? httpClientFactory)
        {
            _httpClient = httpClientFactory?.CreateClient("WillBeThere") ?? throw new ArgumentNullException(nameof(httpClientFactory), $"{nameof(OrganizationProgramHttpRepo)} osztályban http kliens inicizalizálása nem sikerült!");
        }
